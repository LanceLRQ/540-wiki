...
function star() {
	...
	circle = setInterval(function() {
		...
		// 将图片存进数组
		// 灰太狼，
		var wolf_1 = ['image/s0.png', 'image/s1.png', 'image/s2.png', 'image/s3.png', 'image/s4.png', 'image/s5.png',
			'image/s6.png','image/s7.png', 'image/s8.png', 'image/s9.png'
		];
		// 小灰狼
		...
		// 跳出动画
		var appearWolf = ['image/s0.png', 'image/x0.png'];
		// 创建一个img标签
